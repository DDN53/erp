    ...
    <div className="flex-col w-[40%] mx-auto">
      ...
      <div className="flex items-center mb-2">
        ...
        <input
          ...
          type="text"
          className="p-2 ml-auto border border-gray-500 rounded-md w-52 dark:bg-slate-600 dark:text-white text-black "
        />
      </div>
      {/*  */}
      <div className="flex items-center mb-2">
        ...
        <div className="ml-auto text-center">
          ...
          <input
            ...
            onChange={props.handleChange}
            type="text"
            className="w-24 p-2 border border-gray-500 rounded-md dark:bg-slate-600 dark:text-white text-black "
          />
        </div>
        <div className="text-center">
          ...
          <input
            ...
            onChange={props.handleChange}
            type="text"
            className="w-24 p-2 ml-4 border border-gray-500 rounded-md dark:bg-slate-600 dark:text-white text-black "
          />
        </div>
      </div>
      {/*  */}
      ...
      <div className="flex items-center mt-6">
        ...
        <input
          ...
          onChange={props.handleChange}
          type="text"
          className="p-2 ml-auto border border-gray-500 rounded-md w-52 dark:bg-slate-600 dark:dark:text-white text-blacktext-black "
        />
      </div>
    </div>
  );
