...
const Sidebar = ({ isOpen }) => {
  ...
  const [isNewWellExpanded, setIsNewWellExpanded] = useState(false);
  ...
  const toggleNewWell = () => {
    setIsNewWellExpanded((prev) => !prev);
  };
  ...
  return (
    ...
    >
      ...
      <div
        className="p-2 mt-1 mx-4 text-sm font-bold flex items-center justify-between cursor-pointer border-2 rounded-lg hover:bg-gray-400 "
      ...
      {isMainProcessExpanded && (
        <div className="p-1 overflow-y-auto max-h-[calc(100vh-210px)]">
            ...
            <h4 className="text-sm ml-2 cursor-pointer flex items-center border-b p-1 pb-2 pt-2 hover:bg-gray-400 rounded-md">
              <FaNewspaper className="mr-2" style={{ color: "blue", fontSize: "20px" }} />
             New Well
            </h4>
            <div className="ml-4 p-1 hover:bg-gray-400 rounded-md">
              <Link href="/waterProduction/wellrequest" className="cursor-pointer text-sm font-medium">
              Request
              </Link>
            </div>
            <div className="ml-4 p-1 hover:bg-gray-400 rounded-md">
          ...
          <div className="ml-0 mb-2 font-semibold">
            ...
            <div className="ml-4 p-1 hover:bg-gray-400 rounded-md">
              <Link href="/waterProduction/monthlyData" className="cursor-pointer text-sm font-medium">
                Monthly Data
              </Link>
            </div>
          </div>
      ...
      {isReportsExpanded && (
        <div className="p-1 overflow-y-auto max-h-[calc(100vh-230px)]">
          {/* Well Info Reports */}
          <div className="ml-0 mb-2 font-semibold">
            <Link href="/waterProduction/wellreport" className="cursor-pointer text-sm font-medium mt-0">
          ...
          <div className="ml-0 mb-2 font-semibold">
            <Link href="/waterProduction/monthlyreport" className="cursor-pointer text-sm font-medium mt-0">
              <div className="ml-4 p-1 hover:bg-gray-400 rounded-md flex items-center">
